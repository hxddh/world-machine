...
pub(crate) fn bind_keys(cx: &mut gpui::App) {
    cx.bind_keys([
        ...
        KeyBinding::new("left", Left, Some(INPUT_CONTEXT)),
        KeyBinding::new("right", Right, Some(INPUT_CONTEXT)),
        KeyBinding::new("shift-left", SelectLeft, Some(INPUT_CONTEXT)),
        KeyBinding::new("shift-right", SelectRight, Some(INPUT_CONTEXT)),
        KeyBinding::new("cmd-a", SelectAll, Some(INPUT_CONTEXT)),
        KeyBinding::new("cmd-v", Paste, Some(INPUT_CONTEXT)),
        KeyBinding::new("cmd-c", Copy, Some(INPUT_CONTEXT)),
        KeyBinding::new("cmd-x", Cut, Some(INPUT_CONTEXT)),
        KeyBinding::new("home", Home, Some(INPUT_CONTEXT)),
        KeyBinding::new("end", End, Some(INPUT_CONTEXT)),
    ]);
}
