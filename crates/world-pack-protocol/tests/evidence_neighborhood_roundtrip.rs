...
use world_projection::{
    ...
    StateEvidenceEdge, StateEvidenceNeighborhood, StateEvidenceNeighborhoodNode, TimelineItem,
    TimelineProjection, ENTITY_HISTORY_SECTION, RELATION_ENDPOINTS_SECTION,
    RELATION_HISTORY_SECTION,
};

#[test]
fn protocol_v2_preserves_bounded_evidence_neighborhood_across_json_wire_round_trip() {
