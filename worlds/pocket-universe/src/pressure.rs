...
pub(crate) fn copy_for(seed: &str, kind: &str) -> PressureCopy {
    match (seed, kind) {
        ("mars-colony", "relay-silence") => PressureCopy {
            warning_status: "relay quiet",
            warning_summary: "The relay station has missed three scheduled contacts. Nia keeps the log open and nobody says the obvious thing.",
            crisis_status: "out of contact",
            crisis_summary: "Ares has heard nothing from the relay for a month. Whatever is wrong out there, the colony is now the only thing keeping itself alive.",
            lost_status: "on its own",
            lost_summary: "The relay never answered. Ares stopped listening and now counts itself alone on the ridge.",
            hold_title: "Close the loop and live inside it",
            hold_detail: "Nia takes Ares off the schedule entirely and rebuilds the colony's routines around never being answered.",
            hold_status: "self-contained",
            hold_summary: "Ares closed its own loop. Nothing out there answers, and nothing here waits for it any more.",
            reach_title: "Drive out and find out",
            reach_detail: "Tomas takes Kestrel past the far ridge to the relay station itself to learn what happened.",
            reach_status: "answered in person",
            reach_summary: "Tomas drove to the relay and came back with an answer. Ares knows what happened, and knows it is still connected.",
            recover_title: "Raise a new mast",
            recover_detail: "Build a mast of Ares's own and start calling again. The habits of a colony that stopped listening will have to go.",
            recover_status: "calling again",
            recover_summary: "Ares raised its own mast and started calling. The habits of being alone are gone, and its legacy starts over.",
        },
        ("1980s-town", "highway-mall") => PressureCopy {
            warning_status: "quieter Fridays",
            warning_summary: "A mall opened out on the highway. The Friday crowd is thinner than it was, and everyone has noticed.",
            crisis_status: "half empty",
            crisis_summary: "Maple Arcade runs half empty now. Another season like this and the machines start going out one by one.",
            lost_status: "four machines left",
            lost_summary: "The crowd went to the highway. Maple Arcade kept four machines and became somewhere you pass, not somewhere you go.",
            hold_title: "Be what the mall is not",
            hold_detail: "Lena leans all the way into what Maple Street already is — the regulars, the tournaments, the names on the glass.",
            hold_status: "leaning local",
            hold_summary: "Maple Arcade stopped competing with the highway and became more itself. Fewer people, and all of them ours.",
            reach_title: "Put Maple Street on the map",
            reach_detail: "Max books touring players through K-88 and gets the arcade written up beyond the neighborhood.",
            reach_status: "on the circuit",
            reach_summary: "Maple Arcade got onto the circuit. Strangers come on Fridays now, and Maple Street shares its nights.",
            recover_title: "Fill the floor again",
            recover_detail: "Buy back a floor's worth of machines. What the thin years taught the arcade to be will have to be unlearned.",
            recover_status: "floor refilled",
            recover_summary: "Maple Arcade filled its floor again. What the thin years made it is gone, and its legacy starts over.",
        },
        ("penguin-civilization", "early-thaw") => PressureCopy {
            warning_status: "ice reading soft",
            warning_summary: "The thaw is early. Piko reads the ice each moonrise and likes it less each time.",
            crisis_status: "crossings suspended",
            crisis_summary: "The ice will not hold a crossing. Icebridge is cut into pieces until the colony finds another way across.",
            lost_status: "split by water",
            lost_summary: "The ice went out. Icebridge lives on both sides of open water now and crosses only when it must.",
            hold_title: "Walk the long way round",
            hold_detail: "The colony maps a longer route over land and learns to accept every crossing taking a day.",
            hold_status: "walking round",
            hold_summary: "Icebridge walks the long way now. Nothing is quick, and nothing depends on the ice.",
            reach_title: "Ask the outer colonies for hulls",
            reach_detail: "The Aurora Council trades for the outer colonies' boats and for someone who knows how to read water.",
            reach_status: "crossing by water",
            reach_summary: "Icebridge crosses by water now, in hulls it did not build. It moves freely and it owes for it.",
            recover_title: "Raise a bridge that floats",
            recover_detail: "Build a crossing that does not need the ice. What a colony organized around the ice knows will not carry over.",
            recover_status: "floating crossing",
            recover_summary: "Icebridge built a crossing that does not need ice. What it knew about ice is a story now, and its legacy starts over.",
        },
